...
| Componente | Modelo |
|---|---|
| Console remoto | M5Stack Cardputer (M5Stack StampS3) — também funciona fixo como monitor gráfico do nível da Água (ímã, porta da geladeira), sem nenhuma mudança de hardware, só firmware |
